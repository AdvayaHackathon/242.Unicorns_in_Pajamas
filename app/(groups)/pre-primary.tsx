...
import { BookOpen, SquarePen as PenSquare, Headphones, Volume2 } from 'lucide-react-native';
...
export default function PrePrimaryScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <LearningNav title="Pre-Primary Learning" />
      <ScrollView style={styles.content}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <Pressable
            ...
            onPress={() => router.push('/animal-sounds')}>
            <Volume2 size={24} color="#fff" />
            <Text style={styles.buttonText}>Animal Sounds</Text>
          </Pressable>
        </View>
      </ScrollView>
