...
import { BookOpen, SquarePen as PenSquare, Video, Briefcase } from 'lucide-react-native';
...
export default function HighSchoolScreen() {
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <Pressable
            ...
            onPress={() => router.push('/career-paths')}>
